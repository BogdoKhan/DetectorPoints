...
int main() {
	...
	BufferDetectorHitsPoints(hitPointsByLines,
		hitPointsUncert, directionVectors, counter, std::cout);

	logger._info.str("");
	BufferDetectorHitsPoints(hitPointsByLines,
		hitPointsUncert, directionVectors, counter, logger._info);
